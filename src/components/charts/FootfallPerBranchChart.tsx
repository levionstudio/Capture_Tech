  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-semibold text-gray-900">Footfall per Branch</h3>
        <div className="flex items-center gap-2">
          <div className="px-2 py-1 border border-gray-300 rounded cursor-pointer hover:bg-gray-50">
